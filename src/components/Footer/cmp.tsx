          ...
          <Row xs={1} md={2} lg={3} gap="1.5rem">
            ...
            <Col>
              <ul tw='flex items-center lg:justify-center'>
                <li tw='mr-6'><StyledLink>Documentation<StyledIcon2 name='external-link-square-alt' /></StyledLink></li>
                <li tw='mr-0'><StyledLink>Telegram Developers<StyledIcon2 name='external-link-square-alt' /></StyledLink></li>
              </ul>
            </Col>
            <Col>
