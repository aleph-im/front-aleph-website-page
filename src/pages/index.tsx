            ...
            <div tw="relative">
              <Row xs={1} md={6} gap="0">
                <Col xs={1} md={4}>
                  ...
                  <p className="tp-body1 fs-sm md:fs-xl" tw="m-0 md:mr-80">
                    Access trusted off-chain data or computation within a couple
                    lines of code
                  </p>
                  <DappImgContainer tw="py-12">
                    <DappImg />
                  </DappImgContainer>
                  <BulletList
                    size="big"
          ...
          <Container>
            ...
            <Row xs={1} md={6} xsGap="1.5rem" mdGap="0">
              ...
              <Col xs={1} md={2}>
                ...
                <p className="fs-md" tw="mt-0 mb-12 text-center">
        ...
        <StyledSection tw="py-20" ref={ref2}>
          <Container>
            <div tw="mb-16">
              ...
              <p className="fs-md" tw="m-0">
                Discover the exciting future of aleph.im with our comprehensive
                roadmap. Explore the innovative features we have planned for
                2023 and 2024 to continue revolutionizing the decentralized
                cloud landscape.
              </p>
            </div>
            <Row xs={1} md={6} xsGap="2.5rem" mdGap="0">
              <Col xs={1} md={3}>
                <div tw="flex justify-center">
                  <H2 tw="mb-6" type="h3" color="base0">
                    2023
                  </H2>
                </div>
        ...
        <StyledSection tw="p-16">
          <Container>
            <div tw="flex flex-col items-center justify-center">
              ...
              <p className="fs-md" tw="m-0">
                Our dedicated backers and investors who believe in our mission
                and fuel our growth.
              </p>
